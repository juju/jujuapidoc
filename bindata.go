...
// jujugenerateapidocGoMod reads file data from disk. It returns an error on failure.
func jujugenerateapidocGoMod() (*asset, error) {
	path := "/home/rog/src/work/jujuapidoc/jujugenerateapidoc/go.mod"
	name := "jujugenerateapidoc/go.mod"
...
// jujugenerateapidocGoSum reads file data from disk. It returns an error on failure.
func jujugenerateapidocGoSum() (*asset, error) {
	path := "/home/rog/src/work/jujuapidoc/jujugenerateapidoc/go.sum"
	name := "jujugenerateapidoc/go.sum"
	bytes, err := bindataRead(path, name)
	if err != nil {
		return nil, err
	}
...
func jujugenerateapidocProgGo() (*asset, error) {
	path := "/home/rog/src/work/jujuapidoc/jujugenerateapidoc/prog.go"
